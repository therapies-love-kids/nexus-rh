                        ...
                        <div className="collapse-content">
                            <div className="px-10 w-full flex flex-col gap-10">
                                ...
                                <div className="flex justify-between w-full gap-10">
                                    ...
                                    <div className=" aspect-square w-full p-10 bg-primary">
                                        <div className=" aspect-square w-full bg-primary-content"/>
                                    </div>

                                    <div className=" aspect-square w-full p-10 bg-secondary">
                                        <div className=" aspect-square w-full bg-secondary-content"/>
                                    </div>

                                    <div className=" aspect-square w-full p-10 bg-accent">
                                        <div className=" aspect-square w-full bg-accent-content"/>
                                    </div>
                                    
                                    <div className=" aspect-square w-full p-10 bg-info">
                                ...
                                <div className="flex justify-between w-full gap-10">
                                    ...
                                    <div className=" aspect-square w-full p-10 bg-success">
                                        <div className=" aspect-square w-full bg-success-content"/>
                                    </div>

                                    <div className=" aspect-square w-full p-10 bg-warning">
                                        <div className=" aspect-square w-full bg-warning-content"/>
                                    </div>

                                    <div className=" aspect-square w-full p-10 bg-error">
                                        <div className=" aspect-square w-full bg-error-content"/>
                                    </div>

                                    <div className=" aspect-square w-full p-10 bg-neutral">
